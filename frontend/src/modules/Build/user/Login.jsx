// src/models/Build/user/Login.js
      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white shadow-md rounded-md">
        ...
        {!showRoleSelection ? (
          ...
          <div className="space-y-6">
            <h3 className="text-center text-lg font-semibold">Login as:</h3>
            <button onClick={() => handleRoleSelection('company')} className="w-full p-2 text-white bg-blue-600 rounded-md hover:bg-blue-700">
              Company
            </button>
            <button onClick={() => handleRoleSelection('individual')} className="w-full p-2 text-white bg-green-600 rounded-md hover:bg-green-700">
              Individual
            </button>
          </div>
        )}
